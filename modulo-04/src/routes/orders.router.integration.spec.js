...
describe('Router > Integration > Orders', () => {
  it('should return status 200 and a list of orders', async () => {
  ...
  it('should return status 500 and an error message when listOrder rejects', async () => {
  ...
  it('should return status 200 and the newly created order', async () => {
  ...
  it('should return status 500 and an error message when saveOrder rejects', async () => {
    const res = await buildCall('/api/order', 'post');
